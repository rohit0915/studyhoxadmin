      ...
      <div className="home_padding">
        <div className="content_padding">
          <Grid className="Component_main_grid mb-3">
            <Grid item md={9}>
              <h3 className="mb-2">Add NCERT Solution</h3>
              <button
                type="button"
          ...
          <Expand open={Expandbox}>
            <Card className=" mb-2 Card_shadow p-3 mt-3">
              ...
              <Grid className="Component_main_grid">
                ...
                <Grid item md={6} xs={12}>
                  <div className="text_filed_heading">Add Standard</div>
                  <div className=" mt-1">
                    <input
                      type="text"
                      className="form-control "
              ...
              <Grid className="Component_main_grid">
                <Grid item md={12} xs={12}>
                  <div className="text_filed_heading">Select Solution</div>
                  <div className=" mt-1 mr-2">
                    <input
                      type="file"
                      className="form-control "
...
export default HOC(NcertSolution);
